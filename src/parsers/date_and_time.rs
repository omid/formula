...
impl Formula<'_> {
    ...
    pub(crate) fn parse_weekday(pair: Pair<Rule>) -> Result<Expr> {
        ...
        let date = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
    ...
    pub(crate) fn parse_weeknum(_pair: Pair<Rule>) -> Result<Expr> {
    ...
    pub(crate) fn parse_isoweeknum(pair: Pair<Rule>) -> Result<Expr> {
        ...
        let arg = Self::parse_pair(pair.into_inner().next().ok_or(Error::Parser(RULE))?)?;
    ...
    pub(crate) fn parse_eomonth(pair: Pair<Rule>) -> Result<Expr> {
        ...
        let mut args = pair.into_inner();
        let date = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
        let num = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
    ...
    pub(crate) fn parse_days(pair: Pair<Rule>) -> Result<Expr> {
        const RULE: &str = "days";
        let mut args = pair.into_inner();
        let end_date = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
        let start_date = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
    ...
    pub(crate) fn parse_time(pair: Pair<Rule>) -> Result<Expr> {
        const RULE: &str = "time";
        let mut args = pair.into_inner();
        let hour = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
        let minute = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
        let second = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
    ...
    pub(crate) fn parse_date(pair: Pair<Rule>) -> Result<Expr> {
        const RULE: &str = "date";
        let mut args = pair.into_inner();
        let year = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
        let month = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
        let day = Self::parse_pair(args.next().ok_or(Error::Parser(RULE))?)?;
